        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
            <div class="widget widget-one">
                    ...
                    <nav class="breadcrumb-two" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('courts.index') }}">{{trans('court.courts')}}</a></li>
                ...
                <div class="widget-content widget-content-area">
                    <form id="createForm" action="{{ route('courts.store') }}" method="POST">
                        @csrf

                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="namearInput">{{ trans('general.name_ar') }} *</label>
                                <input type="text" class="form-control" id="namearInput" name="name_ar" value="{{ old('name_ar') }}"
