        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
            <div class="widget widget-one">
                <div class="widget-heading">
                    <nav class="breadcrumb-two" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('circut_court_specialities.index')}}">{{trans('circut_court_speciality.circut_court_speciality')}}</a></li>
                ...
                <div class="widget-content widget-content-area">
                    <form id="createForm" action="{{route('circut_court_specialities.edit',$item)}}" method="get">
