var App = function() {
    ...
    function sidebarFunctionality() {
        ...
        function handleActiveMenu(){
            var menuItem = sessionStorage.getItem('main_menu');
            var subItem = sessionStorage.getItem('sub_menu');
            if(menuItem && subItem == null){
                var menu = $('a[data-menu='+menuItem+']');
                menu.closest('li').addClass('active');
            }
            if(subItem){
                var menu = $('a[data-submenu='+subItem+']');
                var parentMenu = menu.closest('li.menu');
                parentMenu.addClass('active');
                menu.closest('li').addClass('active');
                $("ul",parentMenu).addClass('show');
                $(".dropdown-toggle",parentMenu).addClass('collapsed');
            }
            $('a[data-link]').on('click',function(){
                var self = $(this);
                sessionStorage.setItem('main_menu',self.data('menu'));
            ...
            $('a[data-submenu]').on('click',function(){
                var self = $(this);
                sessionStorage.setItem('main_menu',self.data('menu'));
                sessionStorage.setItem('sub_menu',self.data('submenu'));
            });
        }
