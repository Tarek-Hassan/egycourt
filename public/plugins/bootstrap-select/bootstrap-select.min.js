    ...
    (function(g) {
        ...
        k.DEFAULTS = {
            ...
            countSelectedText: function(o, n) {
                return (o == 1) ? "{0} item selected" : "{0} items"
            },
        ...
        k.prototype = {
            ...
            createLi: function() {
                ...
                var v = function(B, y, A, z) {
                    ...
                    return "<span" + (typeof y !== "undefined" ? ' class="' + y + '"' : "") + (A ? ' style="' + A + '"' : "") + (u.options.liveSearchNormalize ? ' data-normalized-text="' + c(l(g(B).html())) + '"' : "") + (typeof z !== "undefined" || z !== null ? ' data-tokens="' + z + '"' : "") + ' role="option">' + B + '<span class="check-mark"><i class="fas fa-check"></i></span></span>'
                };
